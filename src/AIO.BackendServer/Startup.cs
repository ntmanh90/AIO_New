...
using AIO.BackendServer.IdentityServer;
...
namespace AIO.BackendServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "AIO Space API", Version = "v1" });
